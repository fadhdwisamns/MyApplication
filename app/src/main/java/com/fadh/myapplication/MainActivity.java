package com.fadh.myapplication;
    ...
    private void oneClickIcon() {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent imageViewSendIntent = new Intent(MainActivity.this, Game.class);
        ...
        imageView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent imageView2SendIntent = new Intent(MainActivity.this, Game.class);
        ...
        imageView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent imageView3SendIntent = new Intent(MainActivity.this, Game.class);
        ...
        imageView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent imageView4SendIntent = new Intent(MainActivity.this, Game.class);
        ...
        imageView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent imageView5SendIntent = new Intent(MainActivity.this, Game.class);
        ...
        imageView6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent imageView6SendIntent = new Intent(MainActivity.this, Game.class);
        ...
        imageView7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent imageView7SendIntent = new Intent(MainActivity.this, Game.class);
        ...
        imageView8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent imageView8SendIntent = new Intent(MainActivity.this, Game.class);
